...
describe "page has not JSON parse method", ()->
  it "should return results", (done)->
    ...
    post_data = KSON.stringify(
      {
        "origin_url" : "http://shopping.pchome.com.tw/?mod=store&func=style_show&SR_NO=AAAKES",
        "columns": [
          {
            "dom_query": "a[href*='?mod=item&func=exhibit']",
            "col_name": "product page_link",
    ...
    post_req = http.request post_options, (res)=>
      ...
      res.on 'data', (raw_data)=>
        ...
        expect(typeof response_obj.message.result_rows[0]['product page_link']).toBe "string"
        done() 
